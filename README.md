# Lab1: Caring for a Normal Pet (HTML)

A text-based interactive adventure game built with pure HTML where you must care for a mysterious creature that may not be as "normal" as it seems.
